...
[task_local]
#京喜财富岛
0 0,6-23 * * * https://raw.githubusercontent.com/111111/sync/jd_scripts/jd_cfd.js, tag=京喜财富岛, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "0 0,6-23 * * *" script-path=https://raw.githubusercontent.com/111111/sync/jd_scripts/jd_cfd.js,tag=京喜财富岛

===============Surge=================
京喜财富岛 = type=cron,cronexp="0 0,6-23 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/111111/sync/jd_scripts/jd_cfd.js

============小火箭=========
京喜财富岛 = type=cron,script-path=https://raw.githubusercontent.com/111111/sync/jd_scripts/jd_cfd.js, cronexpr="0 0,6-23 * * *", timeout=3600, enable=true
 */
...
!(async () => {
  ...
  let res2 = await getAuthorShareCode('https://raw.githubusercontent.com/111111/updateTeam/main/shareCodes/cfd.json')
  if (!res2) {
    await $.wait(1000)
    res2 = await getAuthorShareCode('https://raw.fastgit.org/111111/updateTeam/main/shareCodes/cfd.json')
  }
