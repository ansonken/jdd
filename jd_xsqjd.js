...
cron 23 7,9 * * * https://raw.githubusercontent.com/333333/jd/main/scripts/jd_xsqjd.js
* */
const $ = new Env('限时抢京豆');
...
!(async () => {
    ...
    if(!res){
        try{res = await getAuthorShareCode('https://gitee.com/999999/share-code/raw/master/shop.json');}catch (e) {}
        if(!res){res = [];}
    }
    if(res.length > 0){
