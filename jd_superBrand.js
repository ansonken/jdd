...
双11特务
APP首页下滑,任务，互助
cron 10 9,13,16,19,20 2-8 11 * https://raw.githubusercontent.com/111111/jd/main/scripts/jd_superBrand.js
* */
const $ = new Env('双11特务');
...
function getShareCode(name) {
  return new Promise(resolve => {
    $.get({
      url: "https://raw.fastgit.org/111111/updateTeam/main/shareCodes/"+name,
      headers: {
      ...
      try {
        if (err) {
          ...
          console.log(`优先账号内部互助，有剩余助力次数再帮【111111】助力`);
