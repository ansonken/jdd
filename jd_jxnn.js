...
[task_local]
#惊喜牛牛
1 1,9,19 * * * https://raw.githubusercontent.com/123/JDJB/main/jd_jxnn.js, tag=惊喜牛牛, img-url=https://github.com/58xinian/icon/raw/master/jdgc.png, enabled=true

================Loon==============
[Script]
cron "1 1,9,19 * * *" script-path=https://raw.githubusercontent.com/123/JDJB/main/jd_jxnn.js,tag=惊喜牛牛

===============Surge=================
惊喜牛牛 = type=cron,cronexp="1 1,9,19 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/123/JDJB/main/jd_jxnn.js

============小火箭=========
惊喜牛牛 = type=cron,script-path=https://raw.githubusercontent.com/123/JDJB/main/jd_jxnn.js, cronexpr="1 1,9,19 * * *", timeout=3600, enable=true
 */
const $ = new Env('牛牛福利');
...
!(async() => {
    ...
    const author = Math.random() > 0.5 ? '123521' : '123521'
...
function getShareCode(name, author = '123521', num = -1, shuffle = false) {
