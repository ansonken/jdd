...
cron 40 12,16 * * * https://raw.githubusercontent.com/111111/jd/main/scripts/jd_fcwb.js
...
!(async () => {
    ...
    let res = [];
    try{res = await getAuthorShareCode('https://raw.githubusercontent.com/111111/share_code/main/fcwb.json');}catch (e) {}
    if(!res){
        try{res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/111111/share_code@main/fcwb.json');}catch (e) {}
        if(!res){res = [];}
    }
    if(res.length > 0){
