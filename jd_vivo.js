/*
第一个号助力作者，其他号助力第一个CK
cron 10 2,9,17 * * * https://raw.githubusercontent.com/111111/jd/main/scripts/jd_vivo.js
...
!(async () => {
    ...
    let res = [];
    try{res = await getAuthorShareCode('https://raw.githubusercontent.com/111111/share_code/main/vivo.json');}catch (e) {}
    if(!res){
        try{res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/111111/share_code@main/vivo.json');}catch (e) {}
        if(!res){res = [];}
    }
    if(res.length > 0){
